...
const Schedule = () => {
  ...
  const [viewMode, setViewMode] = useState('today'); // 'today' | 'previous' | 'specific'
  ...
  return (
    <div className="min-h-screen p-6 bg-gradient-to-br from-indigo-600 via-purple-600 to-pink-600 text-white">
      ...
      <div className="max-w-6xl mx-auto bg-white/10 backdrop-blur-md p-6 rounded-2xl shadow-xl">
        <h1 className="text-3xl font-bold mb-4">Hello, <a href="/profile" className='underline text-blue-300'>{username}</a></h1>
